class Entry {
    ...
    IntValueEntryLogicConfData(stream) {
        ...
        stream.writeLong(1, 41000000 + 5);
        stream.writeLong(3, 0)//Level Required For Unlock Friendly Games
    ...
    IntValueEntryLogicDailyData(stream,session) {
        ...
        stream.writeLong(3, 0)//Disable Content Creator Boost
        stream.writeLong(4, 0)//Disable Content Creator Boost
        stream.writeLong(5, 0)//Disable Content Creator Boost
    }
    RelaseEntry(stream) {
        stream.writeVInt(0)
    }
